...
public class PrincipalEmpleado {
	...
	public static void main(String[] args) {
		...
		/*
		 * conectamos con la base de datos, creamos un objeto conectaDO de la clase ConexionEmpleado
		 */
		...
		conectaDO.consultar("select * from empleados where nombre='Angel'");//******funciona
		conectaDO.buscarPorDni("5555");
